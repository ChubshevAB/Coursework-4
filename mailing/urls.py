...
from .views import (
    ...
    MailingAttemptListView, start_mailing, StartMailingView,
    AllMailingsListView, AllMessagesListView, AllRecipientsListView, AllAttemptsListView, UserListView
)
...
urlpatterns = [
    ...
    # Moderator URLs
    path('moderator/mailings/', AllMailingsListView.as_view(), name='all-mailings-list'),
    path('moderator/messages/', AllMessagesListView.as_view(), name='all-messages-list'),
    path('moderator/recipients/', AllRecipientsListView.as_view(), name='all-recipients-list'),
    path('moderator/attempts/', AllAttemptsListView.as_view(), name='all-attempts-list'),
